#!/usr/bin/env python
# ! labelme标注文件可视化（目标检测相关的）
# python labelme2voc.py /mnt/d/exp/dji_car/dji_data_mix_2voc /mnt/d/exp/dji_car/dji_data_all 
# --labels /mnt/d/exp/dji_car/dji_data_mix_2voc/labels.txt
# * input_dir, output_dir, --labels, noviz
